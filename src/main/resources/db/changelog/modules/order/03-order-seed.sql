...
-- Itens do pedido 1
-- X-Burger
INSERT INTO order_items (order_id, product_id, product_name, quantity, unit_price, subtotal, observations, created_at, updated_at)
SELECT
...
-- (seguir mesmo padrão do pedido 1 para cada item...)
