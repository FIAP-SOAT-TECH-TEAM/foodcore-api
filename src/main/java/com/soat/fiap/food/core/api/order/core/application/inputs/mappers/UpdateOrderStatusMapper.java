...
/**
 * Classe utilitária responsável por mapear objetos entre {@link OrderStatusRequest} e {@link UpdateOrderStatusInput}.
 */
public class UpdateOrderStatusMapper {

    /**
     * Converte um {@link OrderStatusRequest} (camada web.api) em um {@link UpdateOrderStatusInput} (camada de aplicação).
     *
