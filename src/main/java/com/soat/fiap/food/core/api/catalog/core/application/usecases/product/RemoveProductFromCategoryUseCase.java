...
public class RemoveProductFromCategoryUseCase {
     ...
     * @param gateway    Gateway para acesso ao catálogo
     * @return Catálogo atualizado com o produto removido da categoria
     */
    public static Catalog removeProductFromCategory(Long catalogId, Long categoryId, Long productId, CatalogGateway gateway) {
