...
/**
 * Caso de uso: Buscar pagamentos expirados que ainda não foram aprovados ou cancelados.
 */
@Slf4j
public class GetExpiredPaymentsUseCase {
     ...
     *
     * @param gateway Gateway responsável pelo acesso aos dados de pagamento
