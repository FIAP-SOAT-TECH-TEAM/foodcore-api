...
public class OrderStatusMapper {
    ...
    /**
     * Converte um {@link OrderStatusRequest} (camada web.api) em um {@link OrderStatusInput} (camada de aplicação).
     *
     * @param request O DTO da requisição HTTP contendo o novo status.
    ...
    public static OrderStatusInput toInput(OrderStatusRequest request) {
        return new OrderStatusInput(request.getOrderStatus());
    }
}