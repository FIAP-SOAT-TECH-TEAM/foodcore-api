 ...
 * da aplicação, especialmente entre as camadas de interface (web.api),
 * aplicação (input) e domínio.
 *
 * Atua como um tradutor entre {@link CategoryRequest}, {@link CategoryInput} e {@link Category}.
 */
public class CategoryMapper {

    /**
     * Converte um {@link CategoryRequest} (camada web.api) em um {@link CategoryInput}
     * (camada de aplicação).
     *
     * @param request O DTO da requisição HTTP.
     * @return Um objeto {@link CategoryInput} representando os dados a serem processados pela aplicação.
     */
    ...
    /**
     * Converte um {@link CategoryInput} (camada de aplicação) em uma entidade {@link Category}
     * (modelo de domínio).
     *
