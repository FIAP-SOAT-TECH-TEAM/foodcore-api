...
import com.soat.fiap.food.core.api.payment.core.application.mapper.request.GenerateQrCodeRequestMapper;
import com.soat.fiap.food.core.api.payment.core.application.mapper.response.PaymentStatusResponseMapper;
import com.soat.fiap.food.core.api.payment.core.application.mapper.response.QrCodeResponseMapper;
...
import com.soat.fiap.food.core.api.payment.core.domain.ports.out.PaymentRepository;
...
public class PaymentService implements PaymentUseCase {
    ...
    public void initializePayment(OrderCreatedEvent event) {
        ...
        try {
            ...
            var generateQrCodeResponse = acquirerSource.generateQrCode(generateQrCodeBody);
