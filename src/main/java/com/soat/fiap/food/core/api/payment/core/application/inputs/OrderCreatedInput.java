 ...
 * contendo os dados necessários para inicializar um pagamento.
 *
 ...
 */
public record OrderCreatedInput(
        Long orderId,
        String orderNumber,
        Long userId,
     ...
     * @param subtotal     Subtotal (unitário × quantidade).
     * @param observations Observações adicionais do item.
     */
    public record OrderCreatedItemInput(
            Long productId,
            String name,
            Integer quantity,
