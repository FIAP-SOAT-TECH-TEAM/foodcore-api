 ...
 * da aplicação, especialmente entre a camada de aplicação (input) e o domínio.
 *
 * Atua como um tradutor entre {@link ProductInput} e {@link Product}.
 */
public class ProductMapper {
    /**
     * Converte um {@link ProductRequest} (camada web.api) em um {@link ProductInput}
     * (camada de aplicação).
     *
     * @param request O DTO da requisição HTTP.
     * @return Um objeto {@link ProductInput} representando os dados a serem processados pela aplicação.
     */
