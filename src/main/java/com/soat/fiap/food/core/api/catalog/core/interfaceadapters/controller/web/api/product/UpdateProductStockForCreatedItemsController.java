...
/**
 * Controller: Atualizar quantidade em estoque de produtos de acordo com a quantidade solicitada em um pedido.
 *
 */
@Slf4j
public class UpdateProductStockForCreatedItemsController {
    ...
    public static void updateProductStockForCreatedItems(OrderCreatedEvent orderCreatedEvent, DataSource dataSource) {
        ...
        for (ProductStockUpdateInput.ProductStockItemInput productStockItemInput: productStockUpdateInput.items()) {
            ...
            var catalog = UpdateProductStockForCreatedItemsUseCase.updateStockForCreatedItem(
