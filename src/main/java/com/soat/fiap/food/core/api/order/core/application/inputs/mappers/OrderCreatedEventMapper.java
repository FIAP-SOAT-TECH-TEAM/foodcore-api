 ...
 * para o evento {@link OrderCreatedEvent}, incluindo os itens do pedido.
 */
public class OrderCreatedEventMapper {

    /**
     * Converte uma entidade de domínio {@link Order} em um evento {@link OrderCreatedEvent},
     * mapeando seus atributos e seus itens para eventos {@link OrderItemCreatedEvent}.
     *
     * @param order A entidade {@link Order} a ser convertida.
     * @return Um evento {@link OrderCreatedEvent} com os dados do pedido e seus itens.
     */
    ...
    /**
     * Converte um item {@link OrderItem} em um evento {@link OrderItemCreatedEvent}.
     *
