...
public class InitializePaymentController {
    ...
    /**
     * Inicializa o pagamento de um pedido a partir do evento {@link OrderCreatedEvent}.
     *
     * @param event Evento que representa um pedido criado
     * @param paymentDataSource Origem de dados para o gateway de pagamento
     * @param acquirerSource Origem de dados do adquirente
    ...
    public static void initializePayment(
        ...
        try {
            ...
            PublishPaymentInitializationErrorEventUseCase.publishPaymentInitializationErrorEvent(
                    event.getId(), ex.getMessage(), eventPublisherGateway);
        }
    }
}