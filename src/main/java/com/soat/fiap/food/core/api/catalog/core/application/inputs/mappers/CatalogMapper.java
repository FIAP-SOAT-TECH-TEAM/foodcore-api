 ...
 *
 * Atua como um tradutor entre {@link CatalogRequest}, {@link CatalogInput} e {@link Catalog}.
 */
public class CatalogMapper {

    /**
     * Converte um {@link CatalogRequest} (camada web.api) em um {@link CatalogInput}
     * (camada de aplicação).
     *
     * @param request O DTO da requisição HTTP.
     * @return Um objeto {@link CatalogInput} representando os dados a serem processados pela aplicação.
     */
