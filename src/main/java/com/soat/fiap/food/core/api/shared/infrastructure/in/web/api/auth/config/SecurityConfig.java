...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http,
			@Qualifier("jwtAuthenticationFilter") Filter jwtFilter, CustomAccessDeniedHandler accessDeniedHandler,
		...
		http.csrf(AbstractHttpConfigurer::disable)
				.authorizeHttpRequests(authorize -> authorize
						...
						.hasRole("ADMIN")
						.requestMatchers(HttpMethod.GET, "/orders/active")
						.hasRole("ADMIN")
						.requestMatchers(HttpMethod.GET, "/catalogs/**")
						.hasAnyRole("ADMIN", "USER", "GUEST")
						.requestMatchers(HttpMethod.POST, "/catalogs/**")
						.hasRole("ADMIN")
						.requestMatchers(HttpMethod.PATCH, "/catalogs/**")
						.hasRole("ADMIN")
						.requestMatchers(HttpMethod.PUT, "/catalogs/**")
						.hasRole("ADMIN")
						.requestMatchers(HttpMethod.DELETE, "/catalogs/**")
						.hasRole("ADMIN")
						.requestMatchers(HttpMethod.GET, "/payments/*/qrCode")
						.hasAnyRole("ADMIN", "USER", "GUEST")
						.requestMatchers(HttpMethod.GET, "/payments/*/status")
						.hasAnyRole("ADMIN", "USER", "GUEST")
