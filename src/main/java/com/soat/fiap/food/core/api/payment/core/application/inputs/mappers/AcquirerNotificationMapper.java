...
public class AcquirerNotificationMapper {
    ...
    /**
     * Converte um {@link AcquirerNotificationRequest} recebido via Webhook
     * em um {@link AcquirerNotificationInput} utilizado pela camada de aplicação.
     *
     * @param request Notificação recebida do adquirente.
     * @return Objeto {@link AcquirerNotificationInput} com os dados necessários para o use case.
     */
    public static AcquirerNotificationInput toInput(AcquirerNotificationRequest request) {
        return new AcquirerNotificationInput(
                request.getId(),
                request.isLiveMode(),
                request.getType(),
