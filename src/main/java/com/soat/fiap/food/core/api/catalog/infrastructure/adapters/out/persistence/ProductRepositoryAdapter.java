package com.soat.fiap.food.core.api.catalog.infrastructure.adapters.out.persistence;
...
import com.soat.fiap.food.core.api.catalog.infrastructure.adapters.out.persistence.mapper.ProductEntityMapper;
import com.soat.fiap.food.core.api.catalog.infrastructure.adapters.out.persistence.repository.SpringDataCategoryRepository;
import com.soat.fiap.food.core.api.catalog.infrastructure.adapters.out.persistence.repository.SpringDataProductRepository;
...
public class ProductRepositoryAdapter implements ProductRepository {
    ...
    public Optional<Product> findById(Long id) {
        var query = entityManager.createQuery(
            ...
            com.soat.fiap.food.core.api.catalog.infrastructure.adapters.out.persistence.entity.ProductEntity.class
        );
