...
/**
 * Classe utilitária responsável por mapear uma entidade de domínio {@link Order}
 * para o evento {@link OrderCanceledEvent}, incluindo os itens do pedido.
 */
public class OrderCanceledEventMapper {

    /**
     * Converte uma entidade de domínio {@link Order} em um evento {@link OrderCanceledEvent},
     * mapeando seus atributos e os itens cancelados para eventos {@link OrderItemCanceledEvent}.
     *
     * @param order A entidade {@link Order} que foi cancelada.
     * @return Um evento {@link OrderCanceledEvent} com os dados do pedido cancelado.
     */
    ...
    /**
     * Converte um item {@link OrderItem} em um evento {@link OrderItemCanceledEvent}.
     *
     * @param item O item do pedido que foi cancelado.
     * @return Um evento {@link OrderItemCanceledEvent} com os dados do item cancelado.
     */
