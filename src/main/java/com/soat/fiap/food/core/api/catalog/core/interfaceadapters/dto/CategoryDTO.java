...
/**
 * DTO representando a entidade Category.
 * Contém os dados da categoria incluindo seu ID, detalhes,
 * URL da imagem, ordem de exibição, status ativo,
 * lista de produtos associados e timestamps para auditoria.
 */
