...
/**
 * Classe utilitária responsável por mapear {@link OrderCanceledEvent} para o DTO
 * {@link OrderCanceledEventDto}, utilizado para transporte de dados do evento de pedido cancelado.
 */
public class OrderCanceledEventMapper {
	 ...
	 *
	 * @param event Evento de cancelamento de pedido.
	...
	/**
	 * Converte um item do evento {@link OrderCanceledEvent} em seu respectivo DTO {@link OrderItemCanceledEventDto}.
	 *
	 * @param itemItem Evento de item cancelado do pedido.
