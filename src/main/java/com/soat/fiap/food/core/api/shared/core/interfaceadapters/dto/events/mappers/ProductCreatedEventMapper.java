...
/**
 * Classe utilitária responsável por mapear {@link ProductCreatedEvent} para o DTO
 * {@link ProductCreatedEventDto}, utilizado para transporte de dados do evento de produto criado.
 */
public class ProductCreatedEventMapper {
	 ...
	 *
	 * @param event Evento de criação de produto.
