...
public class InitializePaymentUseCase {
     ...
     *
     * @param orderCreatedInput dados do pedido criado
     ...
     */
    public static Payment initializePayment(OrderCreatedInput orderCreatedInput, PaymentGateway paymentGateway, AcquirerGateway acquirerGateway) {
        ...
        var payment = new Payment(
                orderCreatedInput.userId(),
                orderCreatedInput.orderId(),
