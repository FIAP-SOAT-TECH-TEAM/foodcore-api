...
public class UpdateUserUseCase {
	 ...
	 * @param userGateway
	 *            Gateway para acesso ao repositório de usuários
	 * @param securityGateway
	 *            Gateway para operações de segurança, como criptografia de senha
	 * @return Usuário atualizado com senha segura
	 * @throws UserNotFoundException
	 *             Se o usuário não for encontrado
	 * @throws UserConflictException
	 *             Se o documento já estiver sendo utilizado por outro usuário
	 */
	public static User updateUser(Long id, UserInput userInput, UserGateway userGateway,
