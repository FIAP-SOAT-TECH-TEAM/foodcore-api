...
public class UpdateCategoryInCatalogUseCase {
     ...
     * @param categoryInput Categoria a ser atualizada
     * @param gateway Gateway para comunicação com o mundo exterior
     * @return Catalogo com a categoria atualizada
     */
    public static Catalog updateCategoryInCatalog(Long catalogId, Long categoryId, CategoryInput categoryInput, CatalogGateway gateway) {
