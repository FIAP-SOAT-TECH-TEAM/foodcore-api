...
public class CreateUserUseCase {
     ...
     * Cria um usuário.
     *
     * @param userInput Dados do usuário a ser criado
     * @param userGateway Gateway para comunicação com o mundo exterior
     * @param tokenGateway Gateway para geração de token JWT
     * @param securityGateway Gateway para serviços de segurança
     * @return Usuário criado
     * @throws UserNotFoundException Caso usuário seja GUEST e nenhum seja encontrado no banco
     */
    public static User createUser(UserInput userInput, UserGateway userGateway, TokenGateway tokenGateway, SecurityGateway securityGateway) {
