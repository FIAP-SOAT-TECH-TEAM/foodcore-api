...
public class UpdateProductInCategoryUseCase {
     ...
     * @param productInput Produto a ser atualizado
     * @param gateway Gateway para comunicação com o mundo exterior
     * @return Catalogo com o produto atualizado
     */
    public static Catalog updateProductInCategory(Long catalogId, Long categoryId, Long productId, ProductInput productInput, CatalogGateway gateway) {
