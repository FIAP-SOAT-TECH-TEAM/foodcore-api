 ...
 */
@Slf4j
public class UpdateCategoryImageInCatalogController {
    /**
     ...
     */
    public static void updateCategoryImageInCatalog(Long catalogId, Long categoryId, MultipartFile imageFile, DataSource dataSource, ImageDataSource imageDataSource) {
