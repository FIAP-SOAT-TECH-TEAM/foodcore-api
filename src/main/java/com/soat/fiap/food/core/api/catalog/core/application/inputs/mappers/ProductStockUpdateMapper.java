 ...
 * <p>
 * Atua como um tradutor entre {@link OrderItemCreatedEvent} ou
...
public class ProductStockUpdateMapper {
	...
	/**
	 * Converte uma lista de {@link OrderItemCreatedEvent} (evento de criação de
	...
	/**
	 * Converte uma lista de {@link OrderItemCanceledEvent} (evento de cancelamento
