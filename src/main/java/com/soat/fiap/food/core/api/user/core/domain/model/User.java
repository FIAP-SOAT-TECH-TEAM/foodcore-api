...
/**
 * Entidade de domínio que representa um usuário AGGREGATE ROOT: - Toda
 * modificação de entidades internas do agregado devem passar pela entidade
 * raiz; - Único ponto de entrada para qualquer entidade interna do agregado
...
public class User {
	...
	public boolean isGuest() {
		return (this.document == null || this.document.isBlank()) && (this.email == null || this.email.isBlank())
