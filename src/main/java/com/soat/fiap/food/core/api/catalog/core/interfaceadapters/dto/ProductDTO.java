...
/**
 * DTO representando a entidade Product. Contém os dados do produto incluindo
 * seu ID, detalhes, URL da imagem, preço, informações de estoque, ordem de
 * exibição, status ativo e timestamps para auditoria.
 */
