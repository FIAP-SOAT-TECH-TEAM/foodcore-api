...
public class EnsureOrderPaymentIsValidUseCase {
     ...
     *
     * @param id ID do Pedido a ser validado
     * @param paymentGateway Gateway de pagamento para comunicação com o mundo exterior
     * @param orderGateway Gateway de pedido para comunicação com o mundo exterior
