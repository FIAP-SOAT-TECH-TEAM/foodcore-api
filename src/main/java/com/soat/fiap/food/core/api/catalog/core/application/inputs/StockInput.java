 ...
 * contendo os dados necessários para criar ou manipular um estoque.
 *
 * @param quantity Quantidade de itens no estoque
 */
public record StockInput(Integer quantity) {

    /**
     * Construtor para inicializar um {@code StockInput} com a quantidade de estoque.
     *
