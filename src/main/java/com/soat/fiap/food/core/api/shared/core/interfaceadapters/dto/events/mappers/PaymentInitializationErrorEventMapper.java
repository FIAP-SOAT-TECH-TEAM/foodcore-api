...
/**
 * Classe utilitária responsável por mapear {@link PaymentInitializationErrorEvent} para o DTO
 * {@link PaymentInitializationErrorEventDto}, utilizado para transporte de dados do evento de erro na inicialização de pagamento.
 */
public class PaymentInitializationErrorEventMapper {

	/**
	 * Converte um {@link PaymentInitializationErrorEvent} em um {@link PaymentInitializationErrorEventDto}.
	 *
	 * @param event Evento de erro na inicialização de pagamento.
