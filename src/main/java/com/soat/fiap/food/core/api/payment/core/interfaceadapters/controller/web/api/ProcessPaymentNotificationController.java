...
public class ProcessPaymentNotificationController {
     ...
     *
     * @param acquirerNotificationRequest Notificação recebida do adquirente
     * @param paymentDataSource           Origem de dados do pagamento
     * @param acquirerSource              Fonte de dados do adquirente
     * @param eventPublisherSource        Fonte de publicação de eventos
     */
    public static void processPaymentNotification(
            AcquirerNotificationRequest acquirerNotificationRequest,
        ...
        var payment = ProcessPaymentNotificationUseCase.processPaymentNotification(
                acquirerNotificationInput,
                acquirerGateway,
                paymentGateway
        );
