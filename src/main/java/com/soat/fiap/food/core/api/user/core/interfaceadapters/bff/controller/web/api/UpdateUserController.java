...
public class UpdateUserController {
	 ...
	 * @param userRequest
	 *            Requisição com dados do usuário
	 * @param userDataSource
	 *            Fonte de dados utilizada pelo gateway
	 * @param securitySource
	 *            Fonte de dados para operações de segurança
	 * @return Resposta com os dados do usuário atualizado
	 */
	public static UserResponse updateUser(Long id, UserRequest userRequest, UserDataSource userDataSource,
