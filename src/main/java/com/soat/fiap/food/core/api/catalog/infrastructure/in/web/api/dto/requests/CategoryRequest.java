...
public class CategoryRequest {
	...
	@NotNull(message = "O ID do catalogo da categoria é obrigatório") @Schema(description = "Id da categoria", example = "2", required = true)
	...
	@NotNull(message = "O status da categoria é obrigatório") @Schema(description = "Status da categoria", example = "true", required = true)
