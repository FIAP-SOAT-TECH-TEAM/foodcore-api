...
/**
 * Caso de uso: Atualizar quantidade em estoque de produto de acordo com a quantidade cancelada em um pedido.
 *
 */
@Slf4j
public class UpdateProductStockForCanceledItemUseCase {
    ...
    /**
     * Atualiza quantidade em estoque de um produto de acordo com a quantidade cancelada em um pedido.
     *
     ...
     */
    public static Catalog updateStockForCanceledItem(ProductStockUpdateInput.ProductStockItemInput productStockItemInput, CatalogGateway gateway) {
