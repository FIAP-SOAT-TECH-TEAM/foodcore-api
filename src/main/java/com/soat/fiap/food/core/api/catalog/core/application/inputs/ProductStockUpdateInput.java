 ...
 * contendo os dados necessários para atualizar o estoque de produtos.
 *
 * Esse input é utilizado no caso de uso de atualização de estoque
 * após a criação de itens de pedido.
 *
 * @param items Lista de itens com dados de produto e quantidade a ser descontada.
 */
public record ProductStockUpdateInput(List<ProductStockItemInput> items) {

    /**
     * Construtor para inicializar um {@code ProductStockUpdateInput} com os itens de atualização de estoque.
     *
     * @param items Lista de produtos e suas respectivas quantidades.
     */
     ...
     * @param quantity  Quantidade a ser descontada do estoque.
     */
