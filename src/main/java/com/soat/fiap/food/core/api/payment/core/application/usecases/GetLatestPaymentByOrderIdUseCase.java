...
public class GetLatestPaymentByOrderIdUseCase {
     ...
     * @param paymentGateway Gateway responsável por acessar os dados de pagamento.
     * @param accessManagerGateway Gateway responsável por validações de autenticação e autorização.
     ...
     */
    public static Payment getLatestPaymentByOrderId(Long orderId,
