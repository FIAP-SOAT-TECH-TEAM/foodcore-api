...
@DisplayName("AddCategoryToCatalogUseCase - Testes Unitários")
class AddCategoryToCatalogUseCaseTest {
    ...
    @Test
    @DisplayName("Deve adicionar categoria ao catálogo com sucesso")
    ...
    void shouldThrowExceptionWhenCatalogNotFound() {
        ...
        // Act & Assert
        assertThatThrownBy(() -> 
            AddCategoryToCatalogUseCase.addCategoryToCatalog(categoryInput, catalogGateway)
    ...
    @Test
    @DisplayName("Deve adicionar categoria com dados mínimos válidos")
    ...
    @Test
    @DisplayName("Deve manter propriedades do catálogo inalteradas após adicionar categoria")
