...
@DisplayName("RemoveCategoryFromCatalogUseCase - Testes Unitários")
class RemoveCategoryFromCatalogUseCaseTest {
    ...
    @Test
    @DisplayName("Deve remover categoria do catálogo com sucesso")
    ...
    @Test
    @DisplayName("Deve manter propriedades do catálogo inalteradas após remover categoria")
