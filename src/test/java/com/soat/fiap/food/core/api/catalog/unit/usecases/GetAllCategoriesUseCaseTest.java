...
@DisplayName("GetAllCategoriesUseCase - Testes Unitários")
class GetAllCategoriesUseCaseTest {
    ...
    @Test
    @DisplayName("Deve retornar todas as categorias quando catálogo existe")
    ...
    void shouldThrowExceptionWhenCatalogNotFound() {
        ...
        // Act & Assert
        assertThatThrownBy(() -> 
            GetAllCategoriesUseCase.getAllCategories(catalogId, catalogGateway)
    ...
    @Test
    @DisplayName("Deve retornar lista vazia quando catálogo não tem categorias")
    ...
    @Test
    @DisplayName("Deve retornar categorias com produtos")
    ...
    @Test
    @DisplayName("Deve retornar categorias ativas e inativas")
    ...
    @Test
    @DisplayName("Deve manter ordem das categorias")
