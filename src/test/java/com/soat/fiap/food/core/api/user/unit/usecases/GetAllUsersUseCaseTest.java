...
@ExtendWith(MockitoExtension.class) @DisplayName("GetAllUsersUseCase - Testes Unitários")
class GetAllUsersUseCaseTest {

	@Mock
	private UserGateway userGateway;

	@Test @DisplayName("Deve retornar todos os usuários quando existem usuários")
	...
	@Test @DisplayName("Deve retornar usuário único quando existe apenas um")
	...
	@Test @DisplayName("Deve retornar múltiplos usuários com propriedades completas")
	...
	@Test @DisplayName("Deve manter ordem dos usuários retornada pelo gateway")
