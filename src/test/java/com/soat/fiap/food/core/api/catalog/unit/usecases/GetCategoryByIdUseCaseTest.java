...
@DisplayName("GetCategoryByIdUseCase - Testes Unitários")
class GetCategoryByIdUseCaseTest {
    ...
    @Test
    @DisplayName("Deve retornar categoria quando catálogo e categoria existem")
    ...
    void shouldThrowExceptionWhenCatalogNotFound() {
        ...
        // Act & Assert
        assertThatThrownBy(() -> 
            GetCategoryByIdUseCase.getCategoryById(catalogId, categoryId, catalogGateway)
    ...
    @Test
    @DisplayName("Deve retornar categoria específica do catálogo")
    ...
    @Test
    @DisplayName("Deve validar que a categoria pertence ao catálogo correto")
    ...
    @Test
    @DisplayName("Deve retornar categoria mesmo quando vazia de produtos")
