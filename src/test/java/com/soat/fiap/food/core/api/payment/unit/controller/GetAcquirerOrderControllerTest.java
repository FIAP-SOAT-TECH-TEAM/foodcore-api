...
@DisplayName("GetAcquirerOrderController - Testes Unitários")
class GetAcquirerOrderControllerTest {
    ...
    @Test
    @DisplayName("Deve retornar detalhes do pedido do adquirente com sucesso")
    ...
    @Test
    @DisplayName("Deve lançar exceção quando pedido não é encontrado no adquirente")
    ...
    @Test
    @DisplayName("Deve retornar dados quando pedido existe")
    ...
    @Test
    @DisplayName("Deve chamar AcquirerSource com orderId correto")
