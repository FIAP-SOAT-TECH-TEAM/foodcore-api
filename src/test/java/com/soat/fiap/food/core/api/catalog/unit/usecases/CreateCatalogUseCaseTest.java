...
@DisplayName("CreateCatalogUseCase - Testes Unitários")
class CreateCatalogUseCaseTest {
    ...
    @Test
    @DisplayName("Deve criar catálogo com sucesso")
    ...
    @Test
    @DisplayName("Deve lançar exceção quando catálogo já existe com mesmo nome")
    ...
    @Test
    @DisplayName("Deve criar catálogo com nome diferente quando não há conflito")
