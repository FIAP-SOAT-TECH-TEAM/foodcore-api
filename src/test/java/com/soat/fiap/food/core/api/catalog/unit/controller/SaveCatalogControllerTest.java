...
@DisplayName("SaveCatalogController - Testes Unitários")
class SaveCatalogControllerTest {
    ...
    @Test
    @DisplayName("Deve salvar catálogo com sucesso")
    void shouldSaveCatalogSuccessfully() {
        ...
        var response = assertDoesNotThrow(() -> 
            SaveCatalogController.saveCatalog(catalogRequest, catalogDataSource)
        );
    ...
    @Test
    @DisplayName("Deve executar fluxo de criação sem exceções")
    ...
    @Test
    @DisplayName("Deve retornar resposta válida para catálogo criado")
