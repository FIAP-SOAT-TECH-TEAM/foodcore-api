...
@DisplayName("RemoveProductFromCategoryUseCase - Testes Unitários")
class RemoveProductFromCategoryUseCaseTest {
    ...
    @Test
    @DisplayName("Deve remover produto da categoria com sucesso")
    void shouldRemoveProductFromCategorySuccessfully() {
        ...
        // Act
        var result = RemoveProductFromCategoryUseCase.removeProductFromCategory(catalogId, categoryId, productId, catalogGateway);
    ...
    void shouldThrowExceptionWhenCatalogNotFound() {
        ...
        // Act & Assert
        assertThatThrownBy(() -> RemoveProductFromCategoryUseCase.removeProductFromCategory(catalogId, categoryId, productId, catalogGateway))
    ...
    @Test
    @DisplayName("Deve manter propriedades do catálogo inalteradas ao remover produto")
