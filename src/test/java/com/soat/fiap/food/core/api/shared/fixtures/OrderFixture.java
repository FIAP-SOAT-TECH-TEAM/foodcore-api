...
public class OrderFixture {
    ...
    public static Order createOrderWithMultipleItems() {
        var orderItems = List.of(
                ...
                createBeverageOrderItem(),
                createDessertOrderItem()
        );
        return new Order(1L, orderItems);
    }
    ...
    public static OrderItem createValidOrderItem() {
        return new OrderItem(
                1L,  // productId
                "Big Mac",
                new OrderItemPrice(2, new BigDecimal("25.90")),
                null
        );
    }
    ...
    public static OrderItem createBeverageOrderItem() {
        return new OrderItem(
                2L,
                "Coca-Cola",
                new OrderItemPrice(1, new BigDecimal("8.50")),
                "Sem gelo"
        );
    }
    ...
    public static OrderItem createDessertOrderItem() {
        return new OrderItem(
                3L,
                "Torta de Chocolate",
                new OrderItemPrice(1, new BigDecimal("18.90")),
                "Aquecida"
        );
    }
    ...
    public static OrderItem createExpensiveOrderItem() {
        return new OrderItem(
                4L,
                "Combo Premium",
                new OrderItemPrice(1, new BigDecimal("45.00")),
                null
        );
    }
    ...
    public static OrderItem createOrderItemWithObservations() {
        return new OrderItem(
                2L,
                "Batata Frita G",
                new OrderItemPrice(1, new BigDecimal("15.00")),
                "Sem sal"
        );
    }
    ...
    public static CreateOrderInput createCreateOrderInputWithMultipleItems() {
        var orderItems = List.of(
                createValidOrderItemInput(),
                createBeverageOrderItemInput(),
