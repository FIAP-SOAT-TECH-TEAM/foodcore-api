...
@DisplayName("PublishPaymentApprovedEventUseCase - Testes Unitários")
class PublishPaymentApprovedEventUseCaseTest {
    ...
    @Test
    @DisplayName("Deve processar diferentes pagamentos")
    ...
    @Test
    @DisplayName("Deve publicar evento com dados completos do pagamento")
    ...
    @Test
    @DisplayName("Deve publicar evento para pagamento com valor alto")
