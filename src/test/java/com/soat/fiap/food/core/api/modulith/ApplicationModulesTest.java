 ...
 * - A estrutura dos módulos está correta
 * - Não há violações de dependências entre módulos
 * - Não há dependências cíclicas
 * - Os módulos seguem as convenções definidas
 */
...
class ApplicationModulesTest {
    ...
    @Test
    @DisplayName("Deve verificar se a estrutura dos módulos está correta")
    ...
    @Test
    @DisplayName("Deve imprimir a estrutura dos módulos no console")
    ...
    @Test
    @DisplayName("Deve verificar se não há dependências cíclicas entre módulos")
    ...
    @Test
    @DisplayName("Deve verificar se cada módulo tem beans válidos")
    ...
    @Test
    @DisplayName("Deve verificar se os módulos seguem a convenção de nomenclatura")
