...
@DisplayName("GetProductByIdUseCase - Testes Unitários")
class GetProductByIdUseCaseTest {
    ...
    @Test
    @DisplayName("Deve lançar exceção quando catálogo não encontrado")
    ...
    @Test
    @DisplayName("Deve retornar produto quando catálogo, categoria e produto existem")
    ...
    @Test
    @DisplayName("Deve retornar produto específico da categoria")
    ...
    @Test
    @DisplayName("Deve validar que o produto pertence à categoria correta")
    ...
    @Test
    @DisplayName("Deve retornar produto com todas as propriedades")
    ...
    @Test
    @DisplayName("Deve buscar produto em catálogo com múltiplas categorias")
    ...
    @Test
    @DisplayName("Deve executar busca sem exceções")
