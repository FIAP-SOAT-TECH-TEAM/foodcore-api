...
class UserTest {
    ...
    @Test
    @DisplayName("Deve criar usuário válido com todos os campos")
    ...
    @Test
    @DisplayName("Deve criar usuário convidado")
    ...
    @Test
    @DisplayName("Deve validar documento corretamente")
    ...
    @Test
    @DisplayName("Deve retornar falso para documento inválido")
    ...
    @Test
    @DisplayName("Deve validar username corretamente")
    ...
    @Test
    @DisplayName("Deve validar estado interno após criação")
    ...
    @Test
    @DisplayName("Deve validar documento com menos de 11 caracteres")
    ...
    @Test
    @DisplayName("Deve validar nome obrigatório quando há email")
    ...
    @Test
    @DisplayName("Deve validar username muito curto")
    ...
    @Test
    @DisplayName("Deve validar senha muito curta")
    ...
    @Test
    @DisplayName("Deve identificar usuário como convidado quando não tem identificadores")
    ...
    @Test
    @DisplayName("Deve retornar data de criação")
