...
@DisplayName("GetExpiredPaymentsUseCase - Testes Unitários")
class GetExpiredPaymentsUseCaseTest {
    ...
    @Test
    @DisplayName("Deve retornar pagamentos expirados")
    void shouldReturnExpiredPayments() {
        // Arrange
        var expiredPayments = List.of(
    ...
    @Test
    @DisplayName("Deve retornar único pagamento expirado")
