...
@DisplayName("UpdateOrderStatusUseCase - Testes Unitários")
class UpdateOrderStatusUseCaseTest {
    ...
    @Test
    @DisplayName("Deve lançar exceção quando pedido já possui o status informado")
    ...
    @Test
    @DisplayName("Deve atualizar de RECEIVED para PREPARING")
    ...
    @Test
    @DisplayName("Deve atualizar de PREPARING para READY")
    ...
    @Test
    @DisplayName("Deve atualizar de READY para COMPLETED")
