...
@DisplayName("UpdateProductStockForCanceledItemUseCase - Testes Unitários")
class UpdateProductStockForCanceledItemUseCaseTest {
    ...
    @Test
    @DisplayName("Deve atualizar estoque do produto após cancelamento de item do pedido")
    void shouldUpdateProductStockAfterOrderItemCancellation() {
        ...
        // Act
        var result = UpdateProductStockForCanceledItemUseCase.updateStockForCanceledItem(productStockItemInput, catalogGateway);
    ...
    @Test
    @DisplayName("Deve atualizar estoque corretamente com quantidade grande cancelada")
    ...
    @Test
    @DisplayName("Deve restaurar estoque corretamente com quantidade adequada")
    ...
    @Test
    @DisplayName("Deve lançar exceção quando item de produto for nulo")
    void shouldThrowExceptionWhenProductItemIsNull() {
        // Act & Assert
        assertThatThrownBy(() -> UpdateProductStockForCanceledItemUseCase.updateStockForCanceledItem(null, catalogGateway))
                .isInstanceOf(OrderItemNotFoundException.class)
                .hasMessage("Itens de pedido é nulo. Não é possível efetuar atualização de quantidade em estoque.");
    }

    @Test
    @DisplayName("Deve lançar exceção quando catálogo do produto não for encontrado")
    void shouldThrowExceptionWhenProductCatalogNotFound() {
        ...
        // Act & Assert
        assertThatThrownBy(() -> UpdateProductStockForCanceledItemUseCase.updateStockForCanceledItem(productStockItemInput, catalogGateway))
                .isInstanceOf(CatalogNotFoundException.class)
                .hasMessage("Catálogo do produto do item de pedido não encontrado. Não é possível atualizar quantidade em estoque.");

        verify(catalogGateway).findByProductId(productId);
    }

    @Test
    @DisplayName("Deve atualizar estoque com quantidade mínima válida cancelada")
    ...
    @Test
    @DisplayName("Deve restaurar estoque para valor positivo quando estava zerado")
