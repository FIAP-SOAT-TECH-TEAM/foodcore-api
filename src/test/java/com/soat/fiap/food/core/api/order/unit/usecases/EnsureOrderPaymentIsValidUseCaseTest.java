...
@DisplayName("EnsureOrderPaymentIsValidUseCase - Testes Unitários")
class EnsureOrderPaymentIsValidUseCaseTest {
    ...
    @Test
    @DisplayName("Deve validar com sucesso quando pedido e pagamento existem")
    ...
    @Test
    @DisplayName("Deve lançar exceção quando pagamento não existir e status não for RECEIVED")
    ...
    @Test
    @DisplayName("Deve validar com sucesso quando pagamento não existir mas status for RECEIVED")
    ...
    @Test
    @DisplayName("Deve validar com sucesso para diferentes status quando pagamento existe")
    ...
    @Test
    @DisplayName("Deve lançar exceção quando pagamento não existir e status for COMPLETED")
