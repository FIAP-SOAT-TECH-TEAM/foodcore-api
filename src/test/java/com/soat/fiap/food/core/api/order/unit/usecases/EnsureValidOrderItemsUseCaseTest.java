...
@DisplayName("EnsureValidOrderItemsUseCase - Testes Unitários")
class EnsureValidOrderItemsUseCaseTest {
    ...
    @Test
    @DisplayName("Deve validar com sucesso quando todos os itens são válidos")
    void shouldValidateSuccessfullyWhenAllItemsAreValid() {
        ...
        assertThatNoException().isThrownBy(() -> 
            EnsureValidOrderItemsUseCase.ensureValidOrderItems(Collections.singletonList(orderItem), catalogGateway)
        );
    ...
    @Test
    @DisplayName("Deve validar múltiplos itens com sucesso")
    void shouldValidateMultipleItemsSuccessfully() {
        ...
        // Act & Assert
        assertThatNoException().isThrownBy(() -> 
            EnsureValidOrderItemsUseCase.ensureValidOrderItems(orderItems, catalogGateway)
        );
