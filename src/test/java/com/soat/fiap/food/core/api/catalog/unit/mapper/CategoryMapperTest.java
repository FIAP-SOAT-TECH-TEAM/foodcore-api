...
class CategoryMapperTest {
    ...
    @Test
    @DisplayName("Deve mapear CategoryRequest para CategoryInput")
    void shouldMapCategoryRequestToCategoryInput() {
        ...
        // Act
        var categoryInput = assertDoesNotThrow(() -> 
            CategoryMapper.toInput(categoryRequest)
        );
    ...
    @Test
    @DisplayName("Deve mapear CategoryRequest com valores nulos")
    ...
    @Test
    @DisplayName("Deve mapear CategoryRequest com nome em branco")
