...
@ExtendWith(MockitoExtension.class) @DisplayName("GetUserByDocumentUseCase - Testes Unitários")
class GetUserByDocumentUseCaseTest {

	@Mock
	private UserGateway userGateway;

	@Test @DisplayName("Deve retornar usuário quando encontrado por documento")
	...
	@Test @DisplayName("Deve lançar exceção quando usuário não for encontrado por documento")
	...
	@Test @DisplayName("Deve retornar usuário com documento válido")
