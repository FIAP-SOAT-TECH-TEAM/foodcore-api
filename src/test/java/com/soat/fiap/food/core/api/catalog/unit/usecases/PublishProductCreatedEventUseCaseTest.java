...
@DisplayName("PublishProductCreatedEventUseCase - Testes Unitários")
class PublishProductCreatedEventUseCaseTest {
    ...
    @Test
    @DisplayName("Deve publicar evento de produto criado com sucesso")
    ...
    @Test
    @DisplayName("Deve chamar o gateway uma única vez")
    ...
    @Test
    @DisplayName("Deve processar diferentes produtos")
    ...
    @Test
    @DisplayName("Deve publicar evento com dados corretos do produto")
    ...
    @Test
    @DisplayName("Deve publicar evento para produto sem imagem")
    ...
    @Test
    @DisplayName("Deve garantir que timestamp do evento seja criado automaticamente")
    ...
    @Test
    @DisplayName("Deve publicar evento mantendo integridade dos dados do produto")
