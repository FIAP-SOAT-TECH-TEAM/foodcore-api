...
class UserMapperTest {
    ...
    @Test
    @DisplayName("Deve mapear UserRequest para UserInput com sucesso")
    ...
    @Test
    @DisplayName("Deve mapear UserInput para User domain com sucesso")
    ...
    @Test
    @DisplayName("Deve mapear UserRequest com valores nulos")
