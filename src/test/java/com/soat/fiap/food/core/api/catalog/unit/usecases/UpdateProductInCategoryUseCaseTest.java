...
@DisplayName("UpdateProductInCategoryUseCase - Testes Unitários")
class UpdateProductInCategoryUseCaseTest {
    ...
    @Test
    @DisplayName("Deve atualizar produto na mesma categoria com sucesso")
    void shouldUpdateProductInSameCategorySuccessfully() {
        ...
        var productInput = new ProductInput(
                categoryId,
                "Big Mac Atualizado",
                "Hambúrguer atualizado com novos ingredientes",
        ...
        // Act
        var result = UpdateProductInCategoryUseCase.updateProductInCategory(catalogId, categoryId, productId, productInput, catalogGateway);
    ...
    void shouldThrowExceptionWhenCatalogNotFound() {
        ...
        // Act & Assert
        assertThatThrownBy(() -> UpdateProductInCategoryUseCase.updateProductInCategory(catalogId, categoryId, productId, productInput, catalogGateway))
    ...
    @Test
    @DisplayName("Deve mover produto para nova categoria quando categoryId for diferente")
    void shouldMoveProductToNewCategoryWhenCategoryIdIsDifferent() {
        ...
        var productInput = new ProductInput(
                newCategoryId, // Categoria diferente
                "Big Mac Movido",
                "Hambúrguer movido para categoria de bebidas",
        ...
        // Act
        var result = UpdateProductInCategoryUseCase.updateProductInCategory(catalogId, originalCategoryId, productId, productInput, catalogGateway);
    ...
    @Test
    @DisplayName("Deve manter propriedades do catálogo inalteradas ao atualizar produto")
