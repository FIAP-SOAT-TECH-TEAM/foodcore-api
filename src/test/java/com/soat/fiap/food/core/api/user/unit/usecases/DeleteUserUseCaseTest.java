...
class DeleteUserUseCaseTest {
    ...
    @Test
    @DisplayName("Deve excluir usuário com sucesso quando usuário existe")
    ...
    @Test
    @DisplayName("Deve verificar se usuário existe antes de tentar excluir")
    ...
    @Test
    @DisplayName("Deve excluir usuário com ID específico")
