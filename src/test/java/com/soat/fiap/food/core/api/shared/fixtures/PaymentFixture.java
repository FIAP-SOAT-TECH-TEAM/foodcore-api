...
public class PaymentFixture {
    ...
    public static Payment createPendingPayment() {
        ...
        payment.setQrCode("00020126580014br.gov.bcb.pix0136123e4567-e12b-12d1-a456-42661417400052040000530398654041.005802BR5925JOSE DA SILVA SAURO6009SAO PAULO62070503***6304");
        return payment;
    }
    ...
    public static AcquirerPaymentOutput createValidAcquirerPaymentOutput() {
        return new AcquirerPaymentOutput(
                "12345678",  // tid
                PaymentStatus.APPROVED,
                1L,  // externalReference (orderId)
                PaymentMethod.PIX
        );
    }
