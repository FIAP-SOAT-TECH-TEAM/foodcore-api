...
@DisplayName("GetAcquirerOrderUseCase - Testes Unitários")
class GetAcquirerOrderUseCaseTest {
    ...
    @Test
    @DisplayName("Deve retornar ordem do adquirente quando encontrada")
    ...
    @Test
    @DisplayName("Deve executar consulta com gateway correto")
