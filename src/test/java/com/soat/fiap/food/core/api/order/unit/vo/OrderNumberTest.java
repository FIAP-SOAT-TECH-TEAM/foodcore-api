...
class OrderNumberTest {
    ...
    @Test
    @DisplayName("Deve criar OrderNumber válido")
    ...
    @Test
    @DisplayName("Deve formatar número do pedido corretamente")
    ...
    @Test
    @DisplayName("Deve formatar com zero à esquerda no sequencial")
    ...
    @Test
    @DisplayName("Deve formatar com sequencial máximo")
    ...
    @Test
    @DisplayName("Deve lançar exceção para ano inválido - muito pequeno")
    ...
    @Test
    @DisplayName("Deve lançar exceção para ano inválido - muito grande")
    ...
    @Test
    @DisplayName("Deve aceitar ano mínimo válido")
    ...
    @Test
    @DisplayName("Deve aceitar ano máximo válido")
    ...
    @Test
    @DisplayName("Deve aceitar sequencial zero")
