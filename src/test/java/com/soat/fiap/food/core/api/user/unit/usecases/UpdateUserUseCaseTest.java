...
class UpdateUserUseCaseTest {
    ...
    @Test
    @DisplayName("Deve atualizar usuário com documento diferente")
    ...
    @Test
    @DisplayName("Deve manter ID do usuário inalterado durante atualização")
    ...
    @Test
    @DisplayName("Deve validar dados do usuário durante atualização")
