...
class QrCodeTest {
    ...
    @Test
    @DisplayName("Deve criar QrCode com valor válido")
    ...
    @Test
    @DisplayName("Deve lançar exceção para QrCode nulo")
    ...
    @Test
    @DisplayName("Deve lançar exceção para QrCode muito longo")
    ...
    @Test
    @DisplayName("Deve aceitar QrCode com 255 caracteres")
