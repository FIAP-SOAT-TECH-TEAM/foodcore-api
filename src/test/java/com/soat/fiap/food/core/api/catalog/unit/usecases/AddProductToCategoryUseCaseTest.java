...
@DisplayName("AddProductToCategoryUseCase - Testes Unitários")
class AddProductToCategoryUseCaseTest {
    ...
    @Test
    @DisplayName("Deve adicionar produto à categoria com sucesso")
    ...
    void shouldThrowExceptionWhenCatalogNotFound() {
        ...
        // Act & Assert
        assertThatThrownBy(() -> AddProductToCategoryUseCase.addProductToCategory(catalogId, productInput, catalogGateway))
    ...
    @Test
    @DisplayName("Deve executar adição sem exceções para produto válido")
