...
public class CatalogFixture {
    ...
    public static Category createValidCategory() {
        return new Category(
                new Details("Lanches", "Deliciosos lanches artesanais"),
                new ImageUrl("https://example.com/images/lanches.jpg"),
                1,
                true
        );
    }
    ...
    public static Category createBeverageCategory() {
        return new Category(
                new Details("Bebidas", "Bebidas refrescantes e sucos naturais"),
                new ImageUrl("https://example.com/images/bebidas.jpg"),
                2,
                true
        );
    }
    ...
    public static Category createDessertCategory() {
        return new Category(
                new Details("Sobremesas", "Doces e sobremesas irresistíveis"),
                new ImageUrl("https://example.com/images/sobremesas.jpg"),
                3,
                true
        );
    }
    ...
    public static Category createInactiveCategory() {
        return new Category(
                new Details("Categoria Inativa", "Categoria desabilitada para testes"),
                new ImageUrl("https://example.com/images/inactive.jpg"),
                4,
                false
        );
    }
    ...
    public static Product createValidProduct() {
        Product product = new Product(
                new Details("Big Mac", "Delicioso hambúrguer com dois hambúrgueres, alface, queijo, molho especial, cebola e picles em um pão com gergelim"),
                new BigDecimal("25.90"),
                new ImageUrl("https://example.com/images/bigmac.jpg"),
                10
        );
    ...
    public static Product createBeverageProduct() {
        Product product = new Product(
                new Details("Coca-Cola", "Refrigerante Coca-Cola 350ml gelado"),
                new BigDecimal("8.50"),
                new ImageUrl("https://example.com/images/coca.jpg"),
                20
        );
    ...
    public static Product createDessertProduct() {
        Product product = new Product(
                ...
                new ImageUrl("https://example.com/images/torta.jpg"),
                5
        );
    ...
    public static Product createExpensiveProduct() {
        Product product = new Product(
                ...
                new ImageUrl("https://example.com/images/combo-premium.jpg"),
                3
        );
    ...
    public static Product createInactiveProduct() {
        Product product = new Product(
                new Details("Produto Inativo", "Produto desabilitado para testes"),
                new BigDecimal("12.50"),
                new ImageUrl("https://example.com/images/inactive-product.jpg"),
                0
        );
    ...
    public static Product createOutOfStockProduct() {
        Product product = new Product(
                new Details("Produto Sem Estoque", "Produto temporariamente indisponível"),
                new BigDecimal("22.90"),
                new ImageUrl("https://example.com/images/out-of-stock.jpg"),
                0
        );
