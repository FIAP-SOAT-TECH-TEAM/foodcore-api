...
class EventPublisherGatewayTest {
    ...
    @Test
    @DisplayName("Deve publicar evento através do gateway com sucesso")
    ...
    @Test
    @DisplayName("Deve publicar evento string através do gateway")
    ...
    @Test
    @DisplayName("Deve publicar evento nulo através do gateway")
    ...
    @Test
    @DisplayName("Deve delegar corretamente para o eventPublisherSource")
    ...
    @Test
    @DisplayName("Deve publicar eventos de diferentes tipos")
