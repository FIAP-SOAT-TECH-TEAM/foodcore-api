...
@ExtendWith(MockitoExtension.class) @DisplayName("LoginUseCase - Testes Unitários")
class LoginUseCaseTest {
	...
	@Test @DisplayName("Deve fazer login com sucesso quando credenciais válidas")
	...
	@Test @DisplayName("Deve lançar exceção quando usuário não encontrado")
	...
	@Test @DisplayName("Deve lançar exceção quando senha incorreta")
	...
	@Test @DisplayName("Deve retornar usuário completo após login bem-sucedido")
	...
	@Test @DisplayName("Deve validar diferentes emails e senhas")
