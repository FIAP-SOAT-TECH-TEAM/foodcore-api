...
public class UserFixture {
	...
	public static User createGuestUser() {
		return new User(true, "Usuário Convidado", null, null, null, null);
	}

	public static User createUserWithEmail() {
		return new User(false, "Maria Santos", null, "maria@email.com", "senha123456", null);
	}

	public static User createUserWithDocument() {
		return new User(false, "Pedro Oliveira", null, null, "senha123456", "98765432100");
	}

	public static User createUserWithUsername() {
		return new User(false, "Ana Costa", "ana.costa", null, "senha123456", null);
	}
