...
@DisplayName("GenerateTokenUseCase - Testes Unitários")
class GenerateTokenUseCaseTest {
    ...
    @Test
    @DisplayName("Deve gerar token para usuário válido com ID")
    ...
    @Test
    @DisplayName("Deve lançar exceção para usuário nulo")
    void shouldThrowExceptionForNullUser() {
        // Act & Assert
        assertThatThrownBy(() -> 
            GenerateTokenUseCase.generateToken(null, tokenGateway)
    ...
    @Test
    @DisplayName("Deve lançar exceção para usuário sem ID")
