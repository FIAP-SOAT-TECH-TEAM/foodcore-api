...
@DisplayName("DeleteCatalogUseCase - Testes Unitários")
class DeleteCatalogUseCaseTest {
    ...
    @Test
    @DisplayName("Deve deletar catálogo com sucesso")
    void shouldDeleteCatalogSuccessfully() {
        ...
        // Act & Assert
        assertDoesNotThrow(() -> 
            DeleteCatalogUseCase.deleteCatalog(catalogId, catalogGateway)
        );
    ...
    @Test
    @DisplayName("Deve lançar exceção quando catálogo não existe")
    ...
    @Test
    @DisplayName("Deve lançar exceção quando catálogo tem categorias associadas")
