...
@DisplayName("PublishOrderCanceledEventUseCase - Testes Unitários")
class PublishOrderCanceledEventUseCaseTest {
    ...
    @Test
    @DisplayName("Deve publicar evento de pedido cancelado com sucesso")
    ...
    @Test
    @DisplayName("Deve publicar evento com itens do pedido cancelado")
    ...
    @Test
    @DisplayName("Deve publicar evento com dados completos do pedido cancelado")
