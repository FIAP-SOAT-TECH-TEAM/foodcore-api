...
@DisplayName("UpdateCategoryInCatalogUseCase - Testes Unitários")
class UpdateCategoryInCatalogUseCaseTest {
    ...
    @Test
    @DisplayName("Deve atualizar categoria no mesmo catálogo com sucesso")
    void shouldUpdateCategoryInSameCatalogSuccessfully() {
        ...
        // Act
        var result = UpdateCategoryInCatalogUseCase.updateCategoryInCatalog(catalogId, categoryId, categoryInput, catalogGateway);
    ...
    void shouldThrowExceptionWhenCatalogNotFound() {
        ...
        // Act & Assert
        assertThatThrownBy(() -> 
            UpdateCategoryInCatalogUseCase.updateCategoryInCatalog(catalogId, categoryId, categoryInput, catalogGateway)
    ...
    @Test
    @DisplayName("Deve mover categoria para novo catálogo com sucesso")
    void shouldMoveCategoryToNewCatalogSuccessfully() {
        ...
        var categoryInput = new CategoryInput(
                newCatalogId,
                "Categoria Movida",
                "Categoria movida para novo catálogo",
                true,
                1
        );
        ...
        // Act
        var result = UpdateCategoryInCatalogUseCase.updateCategoryInCatalog(originalCatalogId, categoryId, categoryInput, catalogGateway);
    ...
    @Test
    @DisplayName("Deve lançar exceção quando novo catálogo não for encontrado")
    void shouldThrowExceptionWhenNewCatalogNotFound() {
        ...
        // Act & Assert
        assertThatThrownBy(() -> 
            UpdateCategoryInCatalogUseCase.updateCategoryInCatalog(originalCatalogId, categoryId, categoryInput, catalogGateway)
        ).isInstanceOf(CatalogNotFoundException.class)
         .hasMessage("Catalogo não encontrado com id: 999");
    ...
    @Test
    @DisplayName("Deve manter propriedades do catálogo inalteradas após atualizar categoria")
