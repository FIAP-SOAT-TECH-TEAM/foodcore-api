...
class PaymentMethodTest {
    ...
    @Test
    @DisplayName("Deve retornar PaymentMethod para valor válido")
    ...
    @Test
    @DisplayName("Deve retornar descrição correta para cada método")
    ...
    @Test
    @DisplayName("Deve normalizar valores com espaços e hífen")
