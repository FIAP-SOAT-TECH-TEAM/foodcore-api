...
class CategoryMapperTest {
    ...
    @Test
    @DisplayName("Deve mapear CategoryRequest para CategoryInput com sucesso")
    ...
    @Test
    @DisplayName("Deve mapear CategoryInput para Category domain com sucesso")
    void shouldMapCategoryInputToDomain() {
        // Arrange
        CategoryInput input = new CategoryInput(
                2L,
                "Bebidas",
                "Categoria de bebidas variadas",
                false,
                2
        );
