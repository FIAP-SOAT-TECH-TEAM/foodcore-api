...
class AcquirerNotificationMapperTest {
    ...
    @Test
    @DisplayName("Deve mapear AcquirerNotificationRequest para AcquirerNotificationInput com sucesso")
    ...
    @Test
    @DisplayName("Deve mapear AcquirerNotificationRequest com valores nulos")
    ...
    @Test
    @DisplayName("Deve mapear AcquirerNotificationRequest com dados de teste")
