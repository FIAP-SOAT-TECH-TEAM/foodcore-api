...
@DisplayName("GetLatestPaymentByOrderIdUseCase - Testes Unitários")
class GetLatestPaymentByOrderIdUseCaseTest {
    ...
    @Test
    @DisplayName("Deve retornar último pagamento quando existe")
    void shouldReturnLatestPaymentWhenExists() {
        ...
        var result = assertDoesNotThrow(() -> 
            GetLatestPaymentByOrderIdUseCase.getLatestPaymentByOrderId(orderId, paymentGateway, accessManagerGateway)
        );
    ...
    @Test
    @DisplayName("Deve lançar exceção quando não existe pagamento")
    ...
    @Test
    @DisplayName("Deve validar acesso do usuário")
    ...
    @Test
    @DisplayName("Deve processar pagamento expirado corretamente")
    void shouldProcessExpiredPaymentCorrectly() {
        ...
        // Act
        var result = GetLatestPaymentByOrderIdUseCase.getLatestPaymentByOrderId(orderId, paymentGateway, accessManagerGateway);
