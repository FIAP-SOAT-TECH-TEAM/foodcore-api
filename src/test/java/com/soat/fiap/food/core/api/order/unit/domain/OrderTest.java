...
class OrderTest {
    ...
    @Test
    @DisplayName("Deve criar pedido válido com itens")
    ...
    @Test
    @DisplayName("Deve recalcular total após adicionar item")
    ...
    @Test
    @DisplayName("Deve recalcular total após remover item")
    ...
    @Test
    @DisplayName("Deve lançar exceção para lista de itens nula")
    ...
    @Test
    @DisplayName("Deve lançar exceção ao remover item nulo")
    ...
    @Test
    @DisplayName("Deve lançar exceção ao alterar status de pedido completado")
    ...
    @Test
    @DisplayName("Deve lançar exceção ao cancelar pedido em preparação")
    void shouldThrowExceptionWhenCancellingOrderInPreparation() {
        ...
        assertEquals("Não é possível alterar o status de um pedido para cancelado após o início do seu preparo", exception.getMessage());
    }

    @Test
    @DisplayName("Deve lançar exceção ao retornar para status RECEIVED")
    ...
    @Test
    @DisplayName("Deve aplicar desconto válido")
    ...
    @Test
    @DisplayName("Deve lançar exceção para desconto inválido - muito baixo")
    ...
    @Test
    @DisplayName("Deve lançar exceção para desconto inválido - muito alto")
    ...
    @Test
    @DisplayName("Deve retornar datas de auditoria")
    ...
    @Test
    @DisplayName("Deve atualizar data de modificação ao alterar status")
