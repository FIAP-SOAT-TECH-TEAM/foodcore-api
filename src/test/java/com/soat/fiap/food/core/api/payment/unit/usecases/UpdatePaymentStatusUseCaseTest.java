...
@DisplayName("UpdatePaymentStatusUseCase - Testes Unitários")
class UpdatePaymentStatusUseCaseTest {

    @Test
    @DisplayName("Deve atualizar status do pagamento para APPROVED")
    ...
    @Test
    @DisplayName("Deve atualizar status do pagamento para CANCELLED")
    ...
    @Test
    @DisplayName("Deve atualizar status do pagamento para REJECTED")
    ...
    @Test
    @DisplayName("Deve manter outras propriedades do pagamento inalteradas")
