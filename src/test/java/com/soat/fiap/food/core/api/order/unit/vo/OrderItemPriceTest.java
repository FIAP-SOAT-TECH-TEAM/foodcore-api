...
class OrderItemPriceTest {
    ...
    @Test
    @DisplayName("Deve criar OrderItemPrice válido")
    ...
    @Test
    @DisplayName("Deve lançar exceção para preço unitário zero")
    ...
    @Test
    @DisplayName("Deve lançar exceção para preço unitário negativo")
