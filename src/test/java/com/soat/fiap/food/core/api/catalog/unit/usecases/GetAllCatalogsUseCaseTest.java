...
@DisplayName("GetAllCatalogsUseCase - Testes Unitários")
class GetAllCatalogsUseCaseTest {
    ...
    @Test
    @DisplayName("Deve retornar lista de catálogos quando existirem catálogos cadastrados")
    ...
    @Test
    @DisplayName("Deve retornar único catálogo quando existir apenas um catálogo cadastrado")
