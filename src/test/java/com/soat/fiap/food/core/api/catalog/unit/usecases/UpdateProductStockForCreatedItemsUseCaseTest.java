...
@DisplayName("UpdateProductStockForCreatedItemsUseCase - Testes Unitários")
class UpdateProductStockForCreatedItemsUseCaseTest {
    ...
    @Test
    @DisplayName("Deve atualizar estoque do produto após criação de item do pedido")
    void shouldUpdateProductStockAfterOrderItemCreation() {
        ...
        // Act
        var result = UpdateProductStockForCreatedItemsUseCase.updateStockForCreatedItem(productStockItemInput, catalogGateway);
    ...
    @Test
    @DisplayName("Deve atualizar estoque corretamente com quantidade grande")
    ...
    @Test
    @DisplayName("Deve lançar exceção quando quantidade solicitada resulta em estoque negativo")
    void shouldThrowExceptionWhenRequestedQuantityResultsInNegativeStock() {
        ...
        // Act & Assert
        assertThatThrownBy(() -> UpdateProductStockForCreatedItemsUseCase.updateStockForCreatedItem(productStockItemInput, catalogGateway))
    ...
    void shouldThrowExceptionWhenProductItemIsNull() {
        // Act & Assert
        assertThatThrownBy(() -> UpdateProductStockForCreatedItemsUseCase.updateStockForCreatedItem(null, catalogGateway))
    ...
    @Test
    @DisplayName("Deve atualizar estoque com quantidade mínima válida")
