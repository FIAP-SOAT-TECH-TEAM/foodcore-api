...
class OrderCreatedMapperTest {
    ...
    @Test
    @DisplayName("Deve mapear OrderCreatedEvent para OrderCreatedInput com sucesso")
    ...
    @Test
    @DisplayName("Deve mapear OrderCreatedEvent com lista vazia de itens")
    ...
    @Test
    @DisplayName("Deve mapear OrderCreatedEvent com múltiplos itens")
