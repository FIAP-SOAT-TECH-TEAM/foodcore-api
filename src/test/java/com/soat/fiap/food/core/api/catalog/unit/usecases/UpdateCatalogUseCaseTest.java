...
@DisplayName("UpdateCatalogUseCase - Testes Unitários")
class UpdateCatalogUseCaseTest {
    ...
    @Test
    @DisplayName("Deve atualizar catálogo com sucesso quando dados válidos são fornecidos")
    ...
    @Test
    @DisplayName("Deve lançar exceção quando nome já existe para outro catálogo")
    ...
    @Test
    @DisplayName("Deve permitir atualizar catálogo mantendo o mesmo nome")
