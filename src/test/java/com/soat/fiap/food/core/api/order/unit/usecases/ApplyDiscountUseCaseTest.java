...
@DisplayName("ApplyDiscountUseCase - Testes Unitários")
class ApplyDiscountUseCaseTest {
    ...
    @Test
    @DisplayName("Deve aplicar desconto de 10% para usuário com 5 anos de cadastro")
    ...
    @Test
    @DisplayName("Deve aplicar desconto de 20% para usuário com 10 anos de cadastro")
    ...
    @Test
    @DisplayName("Não deve aplicar desconto para usuário com menos de 1 ano de cadastro")
    ...
    @Test
    @DisplayName("Deve aplicar desconto máximo de 94% para usuário muito antigo")
    ...
    @Test
    @DisplayName("Não deve aplicar desconto superior a 95% mesmo para usuário muito antigo")
    ...
    @Test
    @DisplayName("Deve aplicar desconto de 2% para usuário com 1 ano de cadastro")
