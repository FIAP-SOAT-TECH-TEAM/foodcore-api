...
@DisplayName("GetCatalogByIdUseCase - Testes Unitários")
class GetCatalogByIdUseCaseTest {
    ...
    @Test
    @DisplayName("Deve retornar catálogo quando encontrado por ID")
    ...
    @Test
    @DisplayName("Deve retornar catálogo com categorias quando encontrado")
    ...
    @Test
    @DisplayName("Deve retornar catálogo específico por ID válido")
