...
class ProductTest {
    ...
    void shouldCreateValidProduct() {
        ...
        assertEquals("Delicioso hambúrguer com dois hambúrgueres, alface, queijo, molho especial, cebola e picles em um pão com gergelim", product.getDescription());
    ...
    void shouldReturnProductDescription() {
        ...
        // Assert
        assertEquals("Delicioso hambúrguer com dois hambúrgueres, alface, queijo, molho especial, cebola e picles em um pão com gergelim", description);
    }

    @Test
    @DisplayName("Deve retornar ID da categoria")
    ...
    @Test
    @DisplayName("Deve retornar URL da imagem")
    ...
    @Test
    @DisplayName("Deve definir URL da imagem")
    ...
    @Test
    @DisplayName("Deve verificar se URL da imagem está vazia")
    void shouldCheckIfImageUrlIsEmpty() {
        // Arrange
        Product product = new Product(
                new Details("Test Product", "Test description for product"),
    ...
    @Test
    @DisplayName("Deve retornar quantidade de estoque padrão")
    ...
    @Test
    @DisplayName("Deve verificar status de ativo do produto")
    ...
    @Test
    @DisplayName("Deve verificar se categoria está ativa")
    ...
    @Test
    @DisplayName("Deve lançar exceção para detalhes nulos")
    ...
    @Test
    @DisplayName("Deve lançar exceção para ordem de exibição inválida")
