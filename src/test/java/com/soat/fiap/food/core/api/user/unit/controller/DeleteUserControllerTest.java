...
@DisplayName("DeleteUserController - Testes Unitários")
class DeleteUserControllerTest {
    ...
    @Test
    @DisplayName("Deve lançar exceção quando usuário não é encontrado para deletar")
    ...
    @Test
    @DisplayName("Deve chamar métodos corretos do dataSource")
