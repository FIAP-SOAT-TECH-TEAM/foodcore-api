...
import com.soat.fiap.food.core.api.payment.infrastructure.in.event.listener.PaymentOrderEventListener;
...
@DisplayName("PaymentOrderEventListener - Testes Unitários")
class PaymentOrderEventListenerTest {
    ...
    @Test
    @DisplayName("Deve processar evento de pedido criado com sucesso")
    ...
    @Test
    @DisplayName("Deve processar evento de pedido criado com valor alto")
    ...
    @Test
    @DisplayName("Deve processar evento de pedido criado sem userId")
    ...
    @Test
    @DisplayName("Deve processar evento de pedido criado com valor mínimo")
    ...
    @Test
    @DisplayName("Deve processar evento mantendo integridade dos dados")
