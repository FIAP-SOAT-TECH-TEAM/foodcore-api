...
@DisplayName("AssignGuestUserToOrderUseCase - Testes Unitários")
class AssignGuestUserToOrderUseCaseTest {
    ...
    @Test
    @DisplayName("Deve atribuir usuário guest quando pedido não tem usuário")
    ...
    @Test
    @DisplayName("Não deve fazer nada quando pedido já tem usuário")
    ...
    @Test
    @DisplayName("Deve lançar exceção quando usuário guest não for encontrado")
    ...
    @Test
    @DisplayName("Deve atribuir usuário guest com ID específico")
    ...
    @Test
    @DisplayName("Deve manter outras propriedades do pedido inalteradas")
