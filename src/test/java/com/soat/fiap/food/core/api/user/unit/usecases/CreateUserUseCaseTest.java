...
class CreateUserUseCaseTest {
    ...
    @Test
    @DisplayName("Deve retornar usuário existente quando buscar por documento")
    ...
    @Test
    @DisplayName("Deve retornar usuário existente quando buscar por email")
    ...
    @Test
    @DisplayName("Deve criptografar senha quando usuário tem senha e não tem ID")
